...
Future<void> main() async {
  ...
  //await Firebase.initializeApp( options: DefaultFirebaseOptions.currentPlatform, ); // Test Firestore//
  // FirebaseFirestore.instance.collection('test').get().then((snapshot) {
  //   print("Firestore test success: ${snapshot.docs.length} docs found");
  // }).catchError((e) {
